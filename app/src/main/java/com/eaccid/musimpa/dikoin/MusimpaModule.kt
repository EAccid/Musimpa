...
import com.eaccid.musimpa.domain.usecase.GetDiscoverMoviesUseCaseImpl
import com.eaccid.musimpa.domain.usecase.GetDiscoverMoviesWithFilterUseCase
import com.eaccid.musimpa.domain.usecase.GetDiscoverMoviesWithFilterUseCaseImpl
import com.eaccid.musimpa.domain.usecase.GetGenresUseCase
import com.eaccid.musimpa.domain.usecase.GetGenresUseCaseImpl
...
import com.eaccid.musimpa.domain.usecase.GetSearchMoviesUseCaseImpl
...
import com.eaccid.musimpa.ui.movielistscreen.discover.MovieListScreenViewModel
import com.eaccid.musimpa.ui.movielistscreen.search.SearchAndFilterMovieListScreenViewModel
...
val viewModelsModule = module {
    ...
    viewModel { SearchAndFilterMovieListScreenViewModel(get(), get(), get(), get()) }
...
val useCaseModule = module {
    ...
    single<GetDiscoverMoviesUseCase> { GetDiscoverMoviesUseCaseImpl(get(), get()) }
    single<GetDiscoverMoviesWithFilterUseCase> {
        GetDiscoverMoviesWithFilterUseCaseImpl(
            get(),
            get()
        )
    }
    single<GetGenresUseCase> { GetGenresUseCaseImpl(get()) }
    single<GetSearchMoviesUseCase> { GetSearchMoviesUseCaseImpl(get(), get()) }
}
